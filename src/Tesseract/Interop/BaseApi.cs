...
using static Tesseract.EtextDesc;
...
namespace Tesseract.Interop
{
    ...
    public interface ITessApiSignatures
    {
        ...
        #region Progress & Cancel OCRing API.
        ...
        IntPtr MonitorDelete(HandleRef monitor);
        ...
        void MonitorSetCancelFunc(IntPtr monitor, [MarshalAs(UnmanagedType.FunctionPtr)] TessCancelFunc cancelFunc);
        ...
        //void TessMonitorSetCancelThis(HandleRef monitor, IntPtr cancelThis);
        ...
        void MonitorGetCancelThis(HandleRef monitor);

        [RuntimeDllImport(Constants.TesseractDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessMonitorSetProgressFunc")]
        void MonitorSetProgressFunc(IntPtr monitor, [MarshalAs(UnmanagedType.FunctionPtr)] TessProgressFunc progressFunc);//[MarshalAs(UnmanagedType.FunctionPtr)] TessProgressFunc
        ...
        #endregion End Progress & Cancel OCRing API.
    }
